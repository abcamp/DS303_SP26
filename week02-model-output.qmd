...
-   **Coefficients**: the parameters that represent the relationship between predictor variables and the outcome variable, indicating how much the response changes for a one-unit change in the predictor
